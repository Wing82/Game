...

    {
...

        {
...

            {
                ...
                //drawRectangle = new Rectangle(0, 0, currentSprite.Width/4, currentSprite.Height/4);
                ...
                //drawRectangle.X = drawRectangle.X - drawRectangle.Width / 2;
                //drawRectangle.Y = drawRectangle.Y - drawRectangle.Height / 2; 

                //drawRectangle.X = drawRectangle.X + (WindowWidth / 2);
                //drawRectangle.Y = drawRectangle.Y + (WindowHeight / 2);
            ...
            drawRectangle.X = speedX + drawRectangle.X;

            drawRectangle.Y = speedY + drawRectangle.Y;
